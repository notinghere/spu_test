...
def _yacl():
    maybe(
        ...
        name = "yacl",
        urls = [
            "https://github.com/notinghere/yacl_test/archive/refs/tags/0.4.4b3.tar.gz",
        ],
        strip_prefix = "yacl_test-0.4.4b3",
...
def _libpsi():
    maybe(
        ...
        name = "psi",
        urls = [
            "https://github.com/notinghere/psi_test/archive/refs/tags/0.4.0.dev240401.tar.gz",
        ],
        strip_prefix = "psi_test-0.4.0.dev240401",
