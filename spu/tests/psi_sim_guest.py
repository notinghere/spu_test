...
def simple_in_memory_psi_brpc(_):
    ...
    lctx = libspu.link.create_brpc(lctx_desc, 0)
...
#     import os
#     os.environ["system.transport"]=hosts[1]
...
#     os.environ["config.self_role"]="alice"
...
#     lctx = libspu.link.create_brpc_blackbox(lctx_desc, 0)
#     intersection = libpsi.libs.ecdh_psi(lctx,prepare_data())
#     print(intersection)
#     lctx.stop_link()
